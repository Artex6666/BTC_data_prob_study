...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Custom god_curve charts (XRP)")
    parser.add_argument(
        "-4d",
        "--last-4d",
        action="store_true",
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="YYYY-MM-DD",
        help="Un jour UTC (ce). Sortie custom_chart_xrp/day_*/.",
    )
    ...
    if args.day:
        ...
        print(f"\n=== XRP jour UTC {d} ===", flush=True)
        run_chart(CSV_FULL, sub, f"Custom XRP - {d}", day=d)
